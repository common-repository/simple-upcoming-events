...
?>
            ...
            <p><label for="simple_upcoming_events-date_format"><?php _e('Date Format:'); ?> <a href="http://us.php.net/date" target="_blank"><?php _e('reference'); ?></a><input class="widefat" id="simple_upcoming_events-date_format" name="simple_upcoming_events-date_format" type="text" value="<?php echo $date_format; ?>" /></label></p>
